...
<html>
 ...
 <link rel="stylesheet" href="{{asset('comsup/css/vendor/animate/animate.min.css')}}">
 <link type="text/css" rel="stylesheet" media="all" href="{{asset('comsup/js/vendor/mmenu/css/jquery.mmenu.all.css')}}" />
 <link rel="stylesheet" href="{{asset('comsup/js/vendor/videobackground/css/jquery.videobackground.css')}}">
 <link rel="stylesheet" href="{{asset('comsup/css/vendor/bootstrap-checkbox.css')}}">
 
 <link rel="stylesheet" href="{{asset('comsup/js/vendor/rickshaw/css/rickshaw.min.css')}}">
 <link rel="stylesheet" href="{{asset('comsup/js/vendor/morris/css/morris.css')}}">
 <link rel="stylesheet" href="{{asset('comsup/js/vendor/tabdrop/css/tabdrop.css')}}">
 <link rel="stylesheet" href="{{asset('comsup/js/vendor/summernote/css/summernote.css')}}">
 <link rel="stylesheet" href="{{asset('comsup/js/vendor/summernote/css/summernote-bs3.css')}}">
 <link rel="stylesheet" href="{{asset('comsup/js/vendor/chosen/css/chosen.min.css')}}">
 <link rel="stylesheet" href="{{asset('comsup/js/vendor/chosen/css/chosen-bootstrap.css')}}">

    <link href="{{asset('comsup/css/minimal.css')}}" rel="stylesheet">

    <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    <!--[if lt IE 9]>
      <script src="{{asset('comsup/js/html5shiv.js')}}"></script>
      <script src="{{asset('comsup/js/respond.min.js')}}"></script>
    <![endif]-->
  </head>
  <body class="bg-1">
...
<!--             <ul class="nav navbar-nav quick-actions">
  ...
  <li class="dropdown divided">
    ...
    <ul class="dropdown-menu wider arrow nopadding messages">
      ...
      <li>
        <a class="cyan" href="#">
          <div class="profile-photo">
            <img src="{{asset('comsup/images/ici-avatar.jpg')}}" alt />
          </div>
      ...
      <li>
        <a class="green" href="#">
          <div class="profile-photo">
            <img src="{{asset('comsup/images/arnold-avatar.jpg')}}" alt />
          </div>
          <div class="message-info">
      ...
      <li>
        <a href="#">
          <div class="profile-photo">
            <img src="{{asset('comsup/images/profile-photo.jpg')}}" alt />
          </div>
          <div class="message-info">
      ...
      <li>
        <a class="red" href="#">
          <div class="profile-photo">
            <img src="{{asset('comsup/images/peter-avatar.jpg')}}" alt />
          </div>
          <div class="message-info">
      ...
      <li>
        <a class="orange" href="#">
          <div class="profile-photo">
            <img src="{{asset('comsup/images/george-avatar.jpg')}}" alt />
          </div>
          <div class="message-info">
  ...
  <li class="dropdown divided user" id="current-user">
    <div class="profile-photo">
      <img src="comsup/images/profile-photo.jpg" alt />
    </div>
    ...
    <ul class="dropdown-menu arrow settings">
      ...
      <li>
        <a href="#"><i class="glyphicon glyphicon-user"></i> Calendar</a>
      </li>

      <li>
        <a href="#"><i class="glyphicon glyphicon-user"></i> Inbox <span class="badge badge-red" id="user-inbox">3</span></a>
      </li>
...
/Quick Actions -->
                ...
                <ul class="menu">
                  ...
                  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="glyphicon glyphicon-user"></i> Forms <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
                      <li>
                        <a href="form-elements.html">
                          <i class="glyphicon glyphicon-user"></i> Common Elements
                        </a>
                      </li>
                      <li>
                        <a href="validation-elements.html">
                          <i class="glyphicon glyphicon-user"></i> Validation
                        </a>
                      </li>
                      <li>
                ...
                <section class="tile transparent recent-activity">
                  ...
                  <div class="tile-body tab-content nopadding rounded-bottom-corners">
                    ...
                    <ul id="users-tab" class="tab-pane fade in active">
                      <li>
                        <img src="{{asset('comsup/images/peter-avatar.jpg')}}" class="w35" alt>
                      ...
                      <li>
                        <img src="comsup/images/arnold-avatar.jpg" class="w35" alt>
                      ...
                      <li>
                        <img src="comsup/images/ici-avatar.jpg" class="w35" alt>
                      ...
                      <li>
                        <img src="comsup/images/peter-avatar.jpg" class="w35" alt>
                        <span class="user font-slab">Peter <strong>Kay</strong></span>
                        <span class="subject">has been <strong>banned</strong></span>
                    ...
                    <ul id="orders-tab" class="tab-pane fade">
                      ...
                      <li>
                        <img src="comsup/images/george-avatar.jpg" class="w35" alt>
                    ...
                    <ul id="messages-tab" class="tab-pane fade">
                      <li>
                        <img src="comsup/images/profile-photo.jpg" class="w35" alt>
            ...
            <div class="tab-pane active" id="mmenu-users">
              ...
              <ul class="users-list">
                ...
                <li class="online">
                  <div class="media">
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="comsup/images/ici-avatar.jpg" alt>
                    </a>
                    <div class="media-body">
                ...
                <li class="online">
                  <div class="media">
                    ...
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="comsup/images/arnold-avatar.jpg" alt>
                    </a>
                ...
                <li class="online">
                  <div class="media">
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="comsup/images/peter-avatar.jpg" alt>
                ...
                <li class="online">
                  <div class="media">
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="comsup/images/george-avatar.jpg" alt>
                    </a>
                    <div class="media-body">
                ...
                <li class="busy">
                  <div class="media">
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="comsup/images/random-avatar1.jpg" alt>
                    </a>
                    <div class="media-body">
                ...
                <li class="busy">
                  <div class="media">
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="comsup/images/random-avatar2.jpg" alt>
                    </a>
                    <div class="media-body">
              ...
              <ul class="users-list">
                ...
                <li class="offline">
                  <div class="media">
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="comsup/images/random-avatar4.jpg" alt>
                    </a>
                    <div class="media-body">
                ...
                <li class="offline">
                  <div class="media">
                    ...
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="comsup/images/random-avatar5.jpg" alt>
                    </a>
                ...
                <li class="offline">
                  <div class="media">
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="comsup/images/random-avatar6.jpg" alt>
                ...
                <li class="offline">
                  <div class="media">
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="comsup/images/random-avatar7.jpg" alt>
                    </a>
                    <div class="media-body">
                ...
                <li class="offline">
                  <div class="media">
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="comsup/images/random-avatar8.jpg" alt>
                    </a>
                    <div class="media-body">
    ...
    <script type="text/javascript" src="{{asset('comsup/js/vendor/mmenu/js/jquery.mmenu.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('comsup/js/vendor/sparkline/jquery.sparkline.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('comsup/js/vendor/nicescroll/jquery.nicescroll.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('comsup/js/vendor/animate-numbers/jquery.animateNumbers.js')}}"></script>
    <script type="text/javascript" src="{{asset('comsup/js/vendor/videobackground/jquery.videobackground.js')}}"></script>
    <script type="text/javascript" src="{{asset('comsup/js/vendor/blockui/jquery.blockUI.js')}}"></script>

    <script src="{{asset('comsup/js/vendor/flot/jquery.flot.min.js')}}"></script>
    <script src="{{asset('comsup/js/vendor/flot/jquery.flot.time.min.js')}}"></script>
    <script src="{{asset('comsup/js/vendor/flot/jquery.flot.selection.min.js')}}"></script>
    <script src="{{asset('comsup/js/vendor/flot/jquery.flot.animator.min.js')}}"></script>
    <script src="{{asset('comsup/js/vendor/flot/jquery.flot.orderBars.js')}}"></script>
    <script src="{{asset('comsup/js/vendor/easypiechart/jquery.easypiechart.min.js')}}"></script>

    <script src="{{asset('comsup/js/vendor/rickshaw/raphael-min.js')}}"></script> 
    <script src="{{asset('comsup/js/vendor/rickshaw/d3.v2.js')}}"></script>
    <script src="{{asset('comsup/js/vendor/rickshaw/rickshaw.min.js')}}"></script>

    <script src="{{asset('comsup/js/vendor/morris/morris.min.js')}}"></script>

    <script src="{{asset('comsup/js/vendor/tabdrop/bootstrap-tabdrop.min.js')}}"></script>

    <script src="{{asset('comsup/js/vendor/summernote/summernote.min.js')}}"></script>

    <script src="{{asset('comsup/js/vendor/chosen/chosen.jquery.min.js')}}"></script>

    <script src="{{asset('comsup/js/minimal.min.js')}}"></script>
